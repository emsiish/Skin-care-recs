    ...
    const renderStarIcons = (rating) => {
        ...
        return (
            <div className="flex items-center">
                {starArr.map((val, i) => (
                    <div key={i} className="w-8 h-8 flex items-center justify-center text-2xl" style={{ marginRight: '-0.3em' }}>
                    <span
    ...
    return (
        <div className="min-h-screen overflow-hidden">
            <div className="doctor-page text-center">
                <h2 className="text-3xl font-bold mb-2">Doctors</h2>
                            ...
                            <div className="bg-white p-4 rounded-lg shadow-md flex flex-col justify-between">
                                ...
                                <div>
                                    ...
                                    <div className="mt-1 flex justify-center flex-col">
                                        <div className="mb-1">
                                            <button onClick={() => handleFetchRatings(doctor.id, doctor.name)} className="bg-blue-500 text-white p-2 rounded">
                                                Show Ratings
                                            </button>
                                        </div>
                                        <div>
                                            <button onClick={() => setAddRating(doctor.id)} className="bg-blue-500 text-white p-2 rounded">
                                                Add Rating
                                            </button>
                                        </div>
                                    </div>
